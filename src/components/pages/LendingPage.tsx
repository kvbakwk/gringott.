    ...
    >
      ...
      <div className="flex justify-center items-center gap-[6px] w-[200px]">
        ...
        <div className="text-[15px]">
          {parseTime(new Date(loan.created_at))}
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-[120px] gap-1">
        <div className="text-[10px] leading-none opacity-70">
          {loan.status === "paid" ? "spłacona" : `${Math.round(percent)}%`}
        </div>
      ...
      <div
        className={`flex justify-center items-center w-[100px] h-full transition-opacity ${hover && loan.status === "active" ? "opacity-100" : "opacity-0"}`}
      >
        <IconButton
          className="mini"
          onClick={(e) => {
            e.stopPropagation();
            onRepay(rowEl.current!);
          }}
        >
          <Icon>payments</Icon>
        </IconButton>
  ...
  return (
    ...
    >
      <div className="w-[20px] h-full flex items-center justify-center pl-2">
        <Icon className="text-[16px] transform rotate-90">
      ...
      <div className="flex justify-center items-center w-[200px]">spłata</div>
      <div className="flex justify-center items-center w-[120px]">
        {wallet?.name || "portfel"}
      </div>

        ...
        <div className="flex justify-between items-start w-full">
          ...
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-end">
              <div className="text-[10px] font-bold text-on-surface-variant opacity-60 uppercase tracking-widest mb-1">
                Suma w skarbonkach
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
        {items.map((wallet) =>
          renderItem ? (
            ...
            <div
              key={wallet.id}
              className="p-6 bg-white rounded-3xl border border-outline-variant/30 shadow-sm hover:shadow-md transition-all"
            >

...
export default function RepaymentForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isWalletValid = await validateTransactionWalletId(numWalletId, userId);
        const isAmountValid = validateTransactionAmount(numAmount) && numAmount > 0 && numAmount <= maxRepay;
    ...
    return (
        ...
        >
            ...
            <TextFieldOutlined
                ...
                suffixText="zł"
                error={amountErr}
                errorText={parseFloat(amount) > maxRepay ? "kwota większa niż należność" : "wpisz kwotę"}
            >

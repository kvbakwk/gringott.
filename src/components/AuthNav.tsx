  ...
  return (
    <div className="text-primary flex flex-col gap-[10px] w-[270px] h-fit p-[10px]">
      ...
      >
        ...
        <div className="font-extralight text-on-surface-variant text-[22px]">logowanie</div>
      </div>
      <div
        className="flex items-center gap-[18px] h-[70px] px-[19px] py-[18px] rounded-[16px] transition-all hover:cursor-pointer"
        ref={registerEl}
      ...
      >
        ...
        <div className="font-extralight text-on-surface-variant text-[22px]">rejestracja</div>
      </div>
    </div>
  );
}

  ...
  return (
    <div className="flex flex-col gap-[10px] text-primary w-[270px] h-fit p-[10px]">
      <Link
        href="/regulamin"
        target="_blank"
        className="flex items-center gap-[18px] h-[70px] px-[19px] py-[18px] bg-surface rounded-[16px] shadow-md cursor-pointer hover:bg-surface-container-high transition-colors"
      >
